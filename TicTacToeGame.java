...
public class TicTacToeGame extends javax.swing.JFrame {
    ...
    private void t1MouseClicked(java.awt.event.MouseEvent evt) {                                
        ...
        if(playeroneturn)
        {
            t1.setText("O");//player one chale 
            playeroneturn=false;//or chlne k baad yha false ho jaye
            p1.setText("Player 2:Your turn");//jo player likha wha change hote jayga
            
        }
        else
        {
            t1.setText("x");//player one chale 
            playeroneturn=true;
